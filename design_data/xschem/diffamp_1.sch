...
N -300 -10 -280 -10 {lab=0}
N -280 -10 -280 190 {lab=0}
N -280 190 -200 190 {lab=0}
N -100 -10 -70 -10 {lab=0}
N -70 -10 -70 190 {lab=0}
N -300 20 -300 60 {lab=#net2}
...
C {code_shown.sym} -1955 -560 0 0 {name=ngspice only_toplevel=false value="
.param
+ wc=40
+ lc=1
+ w=60
